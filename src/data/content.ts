...
export const blogPosts = [
  {
    id: 1,
    title:
      'Reflections on Building GeoAI Solutions in Resource-Constrained Environments',
    date: '2026-07-20',
    category:
      'Reflections',
    excerpt:
      'Lessons learned from deploying machine learning models for geospatial analysis where compute resources and labeled data are limited.',
    readingTime: '6 min',
    slug:
      'geoai-resource-constraints',
  },

  {
    id: 2,
    title:
      'The Kalabash Mosaics: A Year in Review',
    date: '2026-06-15',
    category:
      'Community',
    excerpt:
      'Looking back at a year of creating educational content, tutorials, and community engagement around geospatial intelligence.',
    readingTime: '5 min',
    slug:
      'kalabash-year-review',
  },

  {
    id: 3,
    title:
      'New Course: Introduction to Spatial Data Science',
    date: '2026-05-30',
    category:
      'Updates',
    excerpt:
      'Announcing a new free course covering Python, GeoPandas, and spatial analysis fundamentals for data professionals.',
    readingTime: '3 min',
    slug:
...

  {
    id: 4,
    title:
      'Why Open-Source GIS Matters for the Future of Spatial Analysis',
    date: '2026-04-18',
    category:
      'Opinion',
    excerpt:
      'The case for QGIS, Python, and open geospatial tools in democratizing access to spatial intelligence.',
    readingTime: '7 min',
    slug:
      'open-source-gis-future',
  },
];
...
export const mediaItems = [
  {
    id: 1,
    title:
      'Building Your First QGIS Plugin with Python',
    date: '2026-07-10',
    type: 'Tutorial',
    description:
      'Step-by-step walkthrough of creating a custom QGIS plugin for automating spatial analysis workflows.',
    duration: '28:45',
    slug:
...

  {
    id: 2,
    title:
      'GeoAI Conference 2026: Keynote on Ethical AI in Geospatial Analysis',
    date: '2026-06-05',
    type: 'Presentation',
    description:
      'Conference keynote discussing responsible AI practices and bias mitigation in geospatial machine learning.',
    duration: '42:15',
    slug:
      'geoai-conference-keynote',
  },

  {
    id: 3,
    title:
      'Satellite Image Classification with Python and Scikit-learn',
    date: '2026-05-18',
    type: 'Tutorial',
    description:
      'Hands-on tutorial demonstrating supervised classification of Sentinel-2 imagery for land cover mapping.',
    duration: '35:20',
    slug:
      'satellite-classification-tutorial',
  },

  {
    id: 4,
    title:
      'Power BI for Spatial Data: Live Demo',
    date: '2026-04-22',
    type: 'Demo',
    description:
      'Interactive demonstration of building location-aware dashboards with Power BI and ArcGIS integration.',
    duration: '25:10',
    slug:
      'power-bi-spatial-demo',
  },

  {
    id: 5,
    title:
      'The Future of Geospatial Intelligence: Panel Discussion',
    date: '2026-03-15',
    type: 'Discussion',
    description:
      'Panel conversation with industry experts on emerging trends in GeoAI, cloud computing, and spatial data infrastructure.',
    duration: '58:30',
    slug:
      'future-geospatial-panel',
  },
];
